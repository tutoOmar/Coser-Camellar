...
@Component({
  ...
  styleUrl: './cortadores.component.scss',
})
export default class CortadoresComponent implements AfterViewInit {
  ...
  ngAfterViewInit() {
    this.analyticsService.logPageVisit('cortadores');
  }
  /**
   *
   * @param value
